package day55_polymorphism.Cars;
...
// Tesla object or the Toyota obj are able to have a refernce of the Car which means this method is flexible to be used with any subclass of the Car
    ...
    class Runner{
        public static void main(String[] args) {
            Car car = new Car();   // using method dynamically with Polymorphism
